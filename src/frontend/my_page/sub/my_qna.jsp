            ...
            <div id="sub_container">
                <ul class="contents_box">
                    <li class="textcenter">
                        ...
                        <div class="search-text">전체 10건</div>
			            ...
			            <ul class="list">
			                ...
			                <li class="list_row">
			                    <div class="item l_num">10</div>
			                    <div class="item l_tit">제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다.
			                        제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">9</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">8</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">7</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">6</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">5</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">4</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status pending">미답변</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">3</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status completed">답변완료</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">2</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status completed">답변완료</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
			                <li class="list_row">
			                    <div class="item l_num">1</div>
			                    <div class="item l_tit">제목입니다.</div>
			                    <div class="item l_stt"><span class="status completed">답변완료</span></div>
			                    <div class="item l_dt">2024.00.00</div>
			                </li>
