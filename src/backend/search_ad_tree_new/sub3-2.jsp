...
<!-- 수정된 CSS 파일 경로 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/sub3-2.css" />
...
<script src="${pageContext.request.contextPath}/static/tree_visual_D3_leaflet.html"></script>
			...
			<div id="sub_container">
				<ul class="contents_box">
					<li class="textcenter">
						...
						<p class="subheading_title">우리 생활 속 보호수의 위치를 찾아보세요</p> <!-- 검색 폼 -->
						<ul class="sub_search_container">
							<li class="sub_search">
								<div class="sub_search_div">
									<form action="/searchtreead/searchTreesByAddress" method="get">
							...
							<div class="swiper">
								<div class="swiper-wrapper sub_menu2">
									<div class="swiper-slide cur_submenu"
										onclick="location.href='/searchtreead/findTree?region=서울'">
										<span>서울</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=경기'">
										<span>경기</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=인천'">
										<span>인천</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=강원'">
										<span>강원</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=충청'">
										<span>충청</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=경상'">
										<span>경상</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=전라'">
										<span>전라</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/searchtreead/findTree?region=제주'">
										<span>제주</span>
									</div>
								</div>
						...
						<ul class="region_paging_ul total_search_mg">
							<li class="region_map">
								...
								<div class="region_map">
									<iframe src="/static/tree_visual_D3_leaflet.html"
											...
											<c:forEach items="${treeList}" var="tree">
												<li>
													<ul class="paging_list">
														<li class="content">
															<h4>${tree.t_tty}</h4> <!-- 보호수명 -->
															<p class="text">${tree.t_ce_na}</p> <!-- 담당기관명 -->
															<p class="address">${tree.t_ad}</p> <!-- 보호수 주소 -->
														</li>
													</ul>
												</li>
											</c:forEach>
