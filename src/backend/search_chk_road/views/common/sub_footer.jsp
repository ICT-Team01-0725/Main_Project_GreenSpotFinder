...
<footer>
    <ul>
        <li>
            <img src="resources/images/logo.png" alt="logo" style="height: 50px;">
            ...
            <ul class="f_menu">
                <li onclick="privacy()"><p>개인정보처리방침</p></li>
                <li onclick="terms_of_use()"><p>이용약관</p></li>
                <li onclick="move_customer()"><p>고객센터</p></li>
                <li onclick="move_notice()"><p>공지사항</p></li>
            </ul>
