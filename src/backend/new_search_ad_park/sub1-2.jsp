...
<!-- 수정된 CSS 파일 경로 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/sub1-2.css" />
						...
						<ul class="sub_search_container">
							<li class="sub_search">
								<div class="sub_search_div">
									<form action="/finalsearchpark/searchParkByAddress" method="get">
							...
							<div class="swiper">
								<div class="swiper-wrapper sub_menu2">
									<div class="swiper-slide cur_submenu"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=서울'">
										<span>서울</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=경기'">
										<span>경기</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=인천'">
										<span>인천</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=강원'">
										<span>강원</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=충청'">
										<span>충청</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=경상'">
										<span>경상</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=전라'">
										<span>전라</span>
									</div>
									<div class="swiper-slide"
										onclick="location.href='/finalsearchpark/findParkByRegion?region=제주'">
										<span>제주</span>
									</div>
								</div>
						...
						<ul class="region_paging_ul total_search_mg">
							<li class="region_map">
								...
								<div class="region_map">
									<iframe src="/static/park_visual_D3_leaflet.html"
								...
								<ul class="paging_list_ul">
									<c:choose>
										<c:when test="${not empty parkList}">
											<c:forEach items="${parkList}" var="road">
												<li>
													<ul class="paging_list">
														<li class="category"><span>지역</span></li>
														<li class="content">
															<h4>${park.p_na}</h4> <!-- 가로수길 이름 -->
															<p class="text">${park.p_ad}</p> <!-- 관리기관명 -->
															<p class="address">${park.p_ce_na}</p> <!-- 가로수길 주소 -->
														</li>
													</ul>
												</li>
											</c:forEach>
