package com.ict.edu.parkvo;

public class ParkVO {
	    private int p_idx;             // 고유번호
	    private String p_num;          // 관리번호
	    ...
	    private String p_ce_na;        // 관리기관명
	    private String p_pho;          // 전화번호
	    private String p_ce_ad;        // 제공기관명
	 ...
	 // getter, setter
	    ...
	    public String getP_ce_na() {
	        return p_ce_na;
	    }
	    
	    public void setP_ce_na(String p_ce_na) {
	        this.p_ce_na = p_ce_na;
	    }
